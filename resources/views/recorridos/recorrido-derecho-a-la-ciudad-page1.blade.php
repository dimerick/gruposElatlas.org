    ...
    <div class="row">
        <div class="panel panel-default">
            <div class="panel-heading">
               <span> Pagina 1 de 12</span>
                {{--<span class="pull-right"><a href="#"> <i class="fa fa-angle-left"></i> Anterior </a> <a href="#"> Siguiente<i class="fa fa-angle-right"></i></a></span>--}}
            ...
            <div class="panel-body">
                ...
                <p>Se describe la historia de la honda y la cruz ,y los sobrevivientes.</p>
            </div>
        </div>
    ...
    <script>
        $('document').ready(function(){
            function initialize() {
                ...
                var mapOptions = {
                    center: new google.maps.LatLng(	6.2683893, 	-75.5375675),
                    zoom: 15,
                ...
                var posGrupo = new google.maps.LatLng(6.2683893, -75.5375675);
