    ...
    <div class="row">
        <div class="panel panel-default">
            <div class="panel-heading">
               <span> Pagina 11 de 12</span>
                <span class="pull-right"><a href="/recorridos/derecho-a-la-ciudad/page10"> <i class="fa fa-angle-left"></i> Anterior </a> <a href="/recorridos/derecho-a-la-ciudad/page12"> Siguiente<i class="fa fa-angle-right"></i></a></span>
            ...
            <div class="panel-body">
                        ...
                        <div id="myCarousel" class="carousel slide">
                            ...
                            <div class="carousel-inner" id="postRecientes">
                                <div class="item active">
                                    <img src="/files/recorridos/Recorrido1DerechoALaCiudad_14 de noviembre_10.jpg">
                ...
                <p>	Asociación cristiana de jóvenes, Enseñar a los jovenes.</p>
            </div>
        </div>
    ...
    <script>
        $('document').ready(function(){
            function initialize() {
                ...
                var mapOptions = {
                    center: new google.maps.LatLng(6.2458037, -75.5566119),
                    zoom: 15,
                ...
                var posGrupo = new google.maps.LatLng(6.2458037, -75.5566119);
