    ...
    <div class="row">
        <div class="panel panel-default">
            <div class="panel-heading">
               <span> Pagina 3 de 12</span>
                <span class="pull-right"><a href="/recorridos/derecho-a-la-ciudad/page2"> <i class="fa fa-angle-left"></i> Anterior </a> <a href="/recorridos/derecho-a-la-ciudad/page4"> Siguiente<i class="fa fa-angle-right"></i></a></span>
            ...
            <div class="panel-body">
                        ...
                        <div id="myCarousel" class="carousel slide">
                            ...
                            <div class="carousel-inner" id="postRecientes">
                                <div class="item active">
                                    <img src="/files/recorridos/Recorrido1DerechoALaCuidad_14 de noviembre_1.jpg">
                ...
                <p>La historia brillar en la cruz ( preescolar).</p>
            </div>
        </div>
    ...
    <script>
        $('document').ready(function(){
            function initialize() {
                ...
                var mapOptions = {
                    center: new google.maps.LatLng(	6.2716035, 	-75.5374257),
                    zoom: 15,
                ...
                var posGrupo = new google.maps.LatLng(6.2716035, -75.5374257);
