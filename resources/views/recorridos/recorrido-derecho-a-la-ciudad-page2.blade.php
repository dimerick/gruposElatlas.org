    ...
    <div class="row">
        <div class="panel panel-default">
            <div class="panel-heading">
               <span> Pagina 2 de 12</span>
                <span class="pull-right"><a href="/recorridos/derecho-a-la-ciudad/page1"> <i class="fa fa-angle-left"></i> Anterior </a> <a href="/recorridos/derecho-a-la-ciudad/page3"> Siguiente<i class="fa fa-angle-right"></i></a></span>
            ...
            <div class="panel-body">
                        ...
                        <div id="myCarousel" class="carousel slide">
                            ...
                            <div class="carousel-inner" id="postRecientes">
                                <div class="item active">
                                    <img src="/files/recorridos/Recorrido1DerechoALaCiudad_14 de noviembre_2.jpg">
                ...
                <p>Mostramos la vida de el barrio y uno de sus integrantes con la casa de la memoria en la honda.</p>
            </div>
        </div>
    ...
    <script>
        $('document').ready(function(){
            function initialize() {
                ...
                var mapOptions = {
                    center: new google.maps.LatLng(	6.268136, 	-75.5375339),
                    zoom: 15,
                ...
                var posGrupo = new google.maps.LatLng(6.268136, -75.5375339);
