    ...
    <div class="row">
        <div class="panel panel-default">
            <div class="panel-heading">
               <span> Pagina 12 de 12</span>
                <span class="pull-right"><a href="/recorridos/derecho-a-la-ciudad/page11"> <i class="fa fa-angle-left"></i> Anterior </a></span>
            ...
            <div class="panel-body">
                        ...
                        <div id="myCarousel" class="carousel slide">
                            ...
                            <div class="carousel-inner" id="postRecientes">
                                <div class="item active">
                                    <img src="/files/recorridos/Recorrido1DerechoALaCiudad_14 de noviembre_11.jpg">
                ...
                <p>Proceso de paz - yo construyó paz con justicia social.</p>
            </div>
        </div>
    ...
    <script>
        $('document').ready(function(){
            function initialize() {
                ...
                var mapOptions = {
                    center: new google.maps.LatLng(6.2457865, -75.5567197),
                    zoom: 15,
                ...
                var posGrupo = new google.maps.LatLng(6.2457865, -75.5567197);
