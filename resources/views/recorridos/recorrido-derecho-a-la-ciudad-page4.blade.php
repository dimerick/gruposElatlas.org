    ...
    <div class="row">
        <div class="panel panel-default">
            <div class="panel-heading">
               <span> Pagina 4 de 12</span>
                <span class="pull-right"><a href="/recorridos/derecho-a-la-ciudad/page3"> <i class="fa fa-angle-left"></i> Anterior </a> <a href="/recorridos/derecho-a-la-ciudad/page5"> Siguiente<i class="fa fa-angle-right"></i></a></span>
            ...
            <div class="panel-body">
                        ...
                        <div id="myCarousel" class="carousel slide">
                            ...
                            <div class="carousel-inner" id="postRecientes">
                                <div class="item active">
                                    <img src="/files/recorridos/Recorrido1DerechoALaCiudad_14 de noviembre_3.jpg">
                ...
                <p>Contando la historia diaria de la mayoría de los barrios en medellin por los grupos armados.</p>
            </div>
        </div>
    ...
    <script>
        $('document').ready(function(){
            function initialize() {
                ...
                var mapOptions = {
                    center: new google.maps.LatLng(	6.2717041, 	-75.5373896),
                    zoom: 15,
                ...
                var posGrupo = new google.maps.LatLng(6.2717041, -75.5373896);
