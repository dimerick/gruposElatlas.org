		...
		this._layer.eachLayer(function(layer) {
			...
			if(layer instanceof L.Marker || layer instanceof L.CircleMarker)
			{
				try {
					...
					else if(_getPath(layer.feature.geometry.properties,propName)){

						loc = layer.getLatLng();
						loc.layer = layer;
						retRecords[ _getPath(layer.feature.geometry.properties,propName) ] = loc;
			...
			{
				try {
					if(layer.feature.geometry.properties.hasOwnProperty(propName))
					{
						loc = layer.getBounds().getCenter();
						loc.layer = layer;
						retRecords[ layer.feature.geometry.properties[propName] ] = loc;
					}
					else
